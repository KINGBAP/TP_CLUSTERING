...
dataset_filenames = ["x1.txt","x2.txt","x3.txt","x4.txt","y1.txt","zz1.txt","zz2.txt"]

for dataset_filename in dataset_filenames:
    print(f"Traitement du jeu de données {dataset_filename}")

    # Charger les données depuis le fichier texte avec unpack=True
    databrut = np.loadtxt(path + dataset_filename, unpack=True)

    # Empiler les colonnes dans un tableau 2D
